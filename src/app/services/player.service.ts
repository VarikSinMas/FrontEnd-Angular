...
export class PlayerService {
  private players = [
    ...
    { id: 3, name: 'Luka Dončić', height:'1,98', age: '26', position: 'Base', number: 77, team: 'Los Angeles Lakers', imageUrl: 'assets/fotos/luka.png', videoUrl: 'doncic.mp4'  },
    ...
    { id: 9, name: 'Zach LaVine', height:'1,96', age: '30', position: 'Escolta', number: 8, team: 'Sacramento Kings' , imageUrl: 'assets/fotos/lavine.png', videoUrl: 'lavine.mp4' },
    { id: 10, name: 'Klay Thompson', height:'1,96', age: '35', position: 'Escolta', number: 11, team: 'Dallas Mavericks', imageUrl: 'assets/fotos/klay.png', videoUrl: 'klay.mp4' },
    ...
    { id: 14, name: 'Jimmy Butler', height:'2,01', age: '35', position: 'Alero', number: 22, team: 'Golden State Warriors' , imageUrl: 'assets/fotos/butler.png', videoUrl: 'butler.mp4' },
    ...
    { id: 23, name: 'Anthony Davis', height:'2,08', age: '32', position: 'Pívot', number: 3, team: 'Dallas Mavericks', imageUrl: 'assets/fotos/davis.png', videoUrl: 'davis.mp4' },
